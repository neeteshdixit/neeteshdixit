...
*   **☕ Java Full Stack Development:**
    *   **Core & OOPs:** Advanced Java, Exception Handling, Collections Framework, Multi-threading.
    *   **Backend Frameworks:** Spring Boot, Spring MVC, Spring Data JPA, Hibernate, Apache Tomcat.
    *   **APIs & Architecture:** RESTful Web Services, Microservices fundamentals.
    *   **Databases:** MySQL, PostgreSQL, Advanced SQL queries.
    *   **Testing & Tools:** Postman, JUnit, Maven, Git & GitHub.

*   **🌐 MERN Stack Development:**
    *   **Frontend:** React.js (Hooks, Context API, Redux), HTML5, CSS3, JavaScript (ES6+).
